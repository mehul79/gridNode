...
resource "aws_security_group" "app" {
  ...
  vpc_id      = aws_vpc.main.id
  # Inline blocks intentionally omitted to strictly enforce standalone aws_security_group_rule usage.
}
...
resource "aws_security_group" "data" {
  ...
  vpc_id      = aws_vpc.main.id
  # Inline blocks intentionally omitted. No egress rule means all outbound is denied.
}

resource "aws_security_group_rule" "data_ingress_postgres" {
  type                     = "ingress"
  from_port                = 5432
  to_port                  = 5432
  protocol                 = "tcp"
